...
exports.changeRecords = void 0;
const Registro_1 = require("../../models/Registro");
function changeRecords(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield Registro_1.Records.findByIdAndUpdate(recordsId, { nomePropriedade });
            res.sendStatus(204);
        }
        catch (_a) {
            res.status(500);
...
exports.changeRecords = changeRecords;
;
